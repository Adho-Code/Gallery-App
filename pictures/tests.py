...
class photomaker_TestCases(TestCase):
    def setUp(self):
        self.category_det = Category(category_det = 'asdfg')

    def test_instance(self):
        self.assertTrue(isinstance(self.category_det,Category))

    def test_save_method(self):
        self.category_det.save_category()
